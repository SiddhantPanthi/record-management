...
public class OptionForm extends javax.swing.JFrame {
    ...
    Vector<Student> database1=new Vector<>();
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/record_management/kjsce.jpg")));
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {
       new SEARCH_STUDENT(database1).setVisible(true);
       
    }

    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        new LOGIN_PAGE(database,database1).setVisible(true);
    }
